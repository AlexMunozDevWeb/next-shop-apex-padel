...
import { PayPalOrderStatusResponse } from '@/modules/payments/domain'
import { iPaymentRepository } from './iPaymentRepository'

export const paymentRepository: iPaymentRepository = {
  setTransactionId: async (orderId, transactionId) => {
    try {
      ...
      if (!order) {
        return { ok: false, message: `No se encontró una orden con el ${orderId}` }
      }
